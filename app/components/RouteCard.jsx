...
const RouteCard = ({ route }) => {
  ...
  return (
    ...
    >      <div 
      ...
      >
        <h3 id={`route-title-${route.id}`} className="text-xl font-bold text-gray-900 mb-2">{route.title}</h3>
        <p className="text-gray-600 text-sm mb-4" aria-label={`Description: ${route.description}`}>{route.description}</p>
        ...
        >
          <button 
            ...
            aria-label={`Book ${route.title} tour starting from ${route.price} rupees`}
          >
            <motion.span
